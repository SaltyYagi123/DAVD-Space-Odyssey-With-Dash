...
from data_processing import load_and_preprocess_data_astronauts, load_and_preprocess_data_missions
...
app.layout = create_layout(df_astronauts, df_space_missions, state_counts, major_counts, missions_per_country, grouped_df)
